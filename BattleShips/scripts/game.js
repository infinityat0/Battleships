...
function Draw()
{
	...
	alert(" Note : The game is not yet stable. " + 
			"\n Occasionally, the computer goes mad. "+ 
			"\n Occasionally, it stacks one ship on the other "+
			"\n Sometimes, it cheats.  "+
			"\n and sometimes it gives you fever ships than usual. \n"+
			"\n If you experience any such behavior kindly ignore it saying everything is fair in love and war.. - Sunny") ;
}
/******************************************************************************/
/**
*
...
function placeBoard()
{
    ...
    for(i = 0 ; i < 5 ; i++){vessels1[i] = placeShip(vessels1[i], board1); /* alert("painting "+vessels1[i].name) */}
    for(i = 0 ; i < 5 ; i++){vessels2[i] = placeShip(vessels2[i], board2); /* alert("painting "+vessels2[i].name) */}
    for(i = 0 ; i < 9 ; i++)
    {
        for(var j = 0 ; j < 9 ; j++)
        {
